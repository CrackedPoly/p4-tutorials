...
control MyEgress(inout headers hdr,
    ...
    apply {
        ...
        if (hdr.probe.isValid()) {
            ...
            last_time_reg.write((bit<32>)standard_metadata.egress_port, (time_t)standard_metadata.egress_global_timestamp);
            hdr.probe_data[0].last_time = last_time;
            hdr.probe_data[0].cur_time = standard_metadata.egress_global_timestamp;
        }
    }
}
